...
a persistence unit "bibliotechPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bibliotech\pom.xml":
...
artifacts ("bibliotech-ejb.jar" and "bibliotech-web.war") are already built. You can build
